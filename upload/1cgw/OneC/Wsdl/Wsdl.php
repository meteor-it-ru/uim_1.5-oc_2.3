...
class OneC_Wsdl_Wsdl
{
	...
	public function addSchemaTypeSection()
	{
		if ($this->_schema === null) {
			...
			//$this->_schema->setAttribute('elementFormDefaul', 'qualified');			
			$this->_schema->setAttribute('targetNamespace', $this->_uri);									
			$import = $this->_dom->createElement('xsd:import');
			$import->setAttribute('namespace', 'http://schemas.xmlsoap.org/soap/encoding/');
			$this->_schema->appendChild($import);
			//$import = $this->_dom->createElement('xsd:import');
			//$import->setAttribute('namespace', 'http://v8.1c.ru/8.1/data/core');
			//$this->_schema->appendChild($import);			
