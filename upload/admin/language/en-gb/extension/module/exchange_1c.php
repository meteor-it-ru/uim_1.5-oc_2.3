<?php
// Heading
$_['heading_title']				= 'M-IT: Управление интернет-магазином 1.3.5';
...
$_['entry_only_1c_options']			= 'Опции товара только из 1С';
...
// Help
$_['help_only_1c_options']			= 'Если включено (рекомендуется) - у товара разрешены опции только из 1С. Опции, добавленные из панели администратора Opencart - будут стираться при выгрузке.<br> Если отключено - при выгрузке будут обновляться только опции выгруженные из 1С. При одинаковых именах опций возможны конфликты.';
